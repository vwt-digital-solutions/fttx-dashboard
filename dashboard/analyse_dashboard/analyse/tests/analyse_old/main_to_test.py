...
def kpn_analysis_variable_use(analyse, df_l, start_time, timeline, total_objects, HP, date_FTU0, date_FTU1):
    ...
    n_err, errors_FC_BC = error_check_FCBC_old(df_l)

    analyse.analyse_documents(date_FTU0, date_FTU1, y_target_l, rc1, x_prog, timeline, d_real_l, df_prog, df_target,
                              df_real,
...
def analyseKPN(client_name, df_l) -> AnalysisKPN:
